...
const testimonials = [
  {
    ...
    quote: "¡MyFinishLine cambió mi forma de entrenar! Ahora cada kilómetro es una aventura emocionante.",
  ...
  },
  {
    ...
    quote: "Une application géniale! Les quêtes virtuelles m'ont aidée à rester constante dans mon entraînement.",
    avatar: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop&crop=face"
  },
  {
    name: "Carlos Rodríguez",
    role: "Triatleta",
    quote: "Perfecto para mantener la motivación durante el entrenamiento. Las recompensas son increíbles.",
  ...
  },
  {
    name: "Pierre Martin",
    role: "Cycliste",
    quote: "Les parcours virtuels sont fantastiques. J'ai découvert l'Amazonie tout en pédalant chez moi!",
